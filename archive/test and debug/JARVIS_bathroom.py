...
# ========================== Extractor Fan ========================
    ...
    try:
        ...
        rec_data, addr = client_socket.recvfrom(2048) #Read response from arduino
        #Pressure = float(rec_data) #Convert string rec_data to float temp
        print "Fan Off" # Print the result
...
# ========================== Loft Fan ========================
    ...
    try:
        ...
        rec_data, addr = client_socket.recvfrom(2048) #Read response from arduino
        #Pressure = float(rec_data) #Convert string rec_data to float temp
        print "Relay 3 On" # Print the result
    ...
    try:
        ...
        rec_data, addr = client_socket.recvfrom(2048) #Read response from arduino
        #Pressure = float(rec_data) #Convert string rec_data to float temp
        print "Relay 3 Off" # Print the result
...
# ========================== Loft Fan ========================
    ...
    data = "Relay4On" #Set data request to Pressure
    ...
    try:
        ...
        rec_data, addr = client_socket.recvfrom(2048) #Read response from arduino
        #Pressure = float(rec_data) #Convert string rec_data to float temp
        print "Relay 4 On" # Print the result
    ...
    data = "Relay4Off" #Set data request to Pressure
    ...
    try:
        ...
        rec_data, addr = client_socket.recvfrom(2048) #Read response from arduino
        #Pressure = float(rec_data) #Convert string rec_data to float temp
        print "Relay 4 Off" # Print the result
